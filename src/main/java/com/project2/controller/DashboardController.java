...
public class DashboardController {
	...
	@RequestMapping(value="/SetBankAccount", method = RequestMethod.POST)
	@ResponseBody
	public BankAccount setBankAccount(@RequestBody BankAccount returnVal) {
		System.out.println(returnVal);
		BankAccount bankAccount = new BankAccount(returnVal.getAmount(), "checking", 
				returnVal.getAccountNumber(), returnVal.getUser());
		bd.createAccount(bankAccount);
